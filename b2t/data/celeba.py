...
class CelebA(Dataset):
    def __init__(self, data_dir='/data/celebA', split='train', transform=None):
        ...
        self.metadata_df = pd.read_csv(os.path.join(self.data_dir, 'list_attr_celeba.csv'), sep=' ')
        self.split_df = pd.read_csv(os.path.join(self.data_dir, 'list_eval_partition.csv'), names=['image_id', "partition"], sep=' ')
